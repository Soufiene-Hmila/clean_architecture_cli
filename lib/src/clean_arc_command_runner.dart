...
bool welcomeBoard() {
  ...
  String content = '''
+---------------------------------------------------+
|      Welcome to the Clean Architecture Cli !               |
+---------------------------------------------------+
...
+---------------------------------------------------+\n''';
  ...
  final validator = answer?.toLowerCase() == 'y' || answer?.toLowerCase() == 'yes';
...
void _errorAndExit([String? command]) {
  ...
  stderr.writeln('try clean_architecture help for commands.');
  exit(2);
}
